...
clc;clear;
%% settings
folder = '/home/tingweiwang/PycharmProjects/DataSet/RemoteImage/RSSCN7/train/';
Savepath_L = 'data/train1.h5';
Savepath_H = 'data/train2.h5';
Savepath_V = 'data/train3.h5';
Savepath_D = 'data/train4.h5';
